...
<html lang="en">
  <head>
    ...
    <title>Author DSL Specification - Lexi (0x800a6)</title>
    <meta name="description" content="Complete specification and testing interface for the Author DSL parser - a robust configuration language for author profiles and metadata.">
    <meta name="keywords" content="author dsl, parser, configuration, metadata, testing, specification">
  ...
  <body>
    <h1>AUTHOR.TXT DSL Specification v1.0</h1>
    <p>
