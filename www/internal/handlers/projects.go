...
func ProjectsHandler(w http.ResponseWriter, r *http.Request, tmplData models.TemplateData) {
	data := tmplData
	...
	allTmpl, err = allTmpl.ParseFiles(utils.GetTemplatePath("html/projects.html"))
	if err != nil {
